...
# Para crear deployment corrigiendo el error que genera por no ser archivo UTF-8

```
kubectl create deployment client-gateway --image=<registro/url/imagen> --dry-run=client --output=yaml | Out-File deployment.yaml -Encoding UTF8
````
